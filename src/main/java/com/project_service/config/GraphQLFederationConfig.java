...
public class GraphQLFederationConfig {
    ...
    private final ProjectRepository projectRepository; // Injete o seu repositório
    ...
    public RuntimeWiringConfigurer runtimeWiringConfigurer() {
        return wiringBuilder -> wiringBuilder
                // Adiciona o scalar para LocalDate
                .scalar(ExtendedScalars.Date) // Ou ExtendedScalars.DateTime / ExtendedScalars.Time se precisar
                .scalar(ExtendedScalars.Object) // Para tipos genéricos, se necessário
                .scalar(ExtendedScalars.LocalTime) // Especificamente LocalDate
